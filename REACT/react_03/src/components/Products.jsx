...
const Products = ({img, name, description, price}) => {
    ...
    */}
            ...
            {/* Props desestructurados. Permite asignar datos de un objeto a una variable separada para que dicha variable pueda contener los datos provinientes del objeto.
...
*/}
            ...
            <div className="cards">
                <div className="products--card" alt='sneakers'>
                    <img src={img} />
                    <h3>{name}</h3>
                    <p>{description}</p>
                    <h4>{price}</h4>
